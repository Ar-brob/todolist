...
const whiter = document.getElementsByClassName('whiter')
const nighter = document.getElementsByClassName('nighter')
const net = document.getElementById('net')
const darknet = document.getElementsByClassName('darknet')
const lightnet = document.getElementsByClassName('lightnet ')
const closesar = document.getElementById('closesar')
const closesardark = document.getElementsByClassName('closesardark')
const closesarwhite = document.getElementsByClassName('closesarwhite')
document.getElementById('klick') .addEventListener ('click', (event) => {
    ...
    if (tip === 'bright' ) {
       ...
       wind2.classList = 'nighter'
       net.classList = 'darknet'
       closesar.classList = 'closesardark'
 } else {
            document.body.classList = 'bright'
             ...
             nit.classList = 'lightnit'
              ...
              wind2.classList = 'whiter'
              net.classList = 'lightnet'
              closesar.classList = 'closesarwhite'
